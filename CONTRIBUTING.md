...
We want to make it as easy as possible to contribute changes that help the [EditorJS Undo][repo] library to grow and thrive. There are a few guidelines that we ask contributors to follow so that we can merge your changes quickly.
